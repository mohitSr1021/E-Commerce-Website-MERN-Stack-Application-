...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    e.preventDefault();
    let userCredential = { email: loginEmail, password: loginPassword };
    try {
      const actionResult = await dispatch(loginUser(userCredential));
    ...
    <section className="h-100 my-5">
      <div className="container py-5 h-100">
        <div className="row d-lg-flex justify-content-center align-items-center h-100">
          ...
          <div className="col col-md-5 col-lg-6 col-sm-6 col-12 d-flex justify-content-center">
            <div className="card w-100 border-0">
              <div className="card-body p-4 p-lg-6 p-sm-0 p-3 text-black text-center">
                <form className="w-100" onSubmit={handleLogin}>
                  ...
                  <Link className="small text-muted mb-2" to="/reset-Password">
                    Forgot password?
                  </Link>
